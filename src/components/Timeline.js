    ...
    return (
      <div className="container">
        ...
        <div className="timeline-container">
            ...
            <TimelineItem from="2021-07-27 8:00pm" to="9:00pm" title="Workshop: Building a Serverless App on AWS" description="An introduction of different AWS services for small scope application development, such as S3, EC2, Lambda, DynamoDb. <br/>Host: Yusra Al-Sharafi, Solutions architect at Amazon Web Service." />
            ...
            <TimelineItem from="2021-08-01 7:00pm" to="2021-08-05 11:59pm" title="Presentation Submission" description="You can start building your project as soon as your group leader receives the rule book. Submissions will close at 3pm EST. One person from each group is expected to submit a presentation deck and other group information via google Form given to their emails." />
