    ...
    return (
      <div className="container">
        ...
        <div className="timeline-container">
            <TimelineItem from="2021-07-08" to="2021-07-22" title="Team Sign-up Period" description="Registration opens for participants." />
            ...
            <TimelineItem from="TBA" to="" title="Workshop: ML Appilication in Mental Health" description="An introduction of different ML models and its application in mental health research. Host: Parsa Mah, Postdoctoral Researcher at CRIM, Research Project Lead at AIML. " />
            <TimelineItem from="TBA" to="" title="Workshop: Introduction to AWS" description="An introduction of different AWS services for small scope application development, such as S3, EC2, Lambda, DynamoDb. Host: Yusra Ai-Sharfi, Solution architect at Amazon Web Service, previous technology specialist at Bell." />
